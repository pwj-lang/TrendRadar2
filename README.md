...
- **热榜域名安全校验**：新增 `expected_domain` 配置项，自动验证每条热榜链接的域名，有效防止链接劫持和数据篡改
- **自定义 API 地址**：新增 `platforms.api_url` 配置项，支持指向自部署的 newsnow API 实例
- **配置版本更新**：config.yaml 升级至 v2.3.0，MCP Server 升级至 v4.1.0
